  ...
  final List<Map<String, dynamic>> questions = [
    {
      ...
      'options': ['Moins de 2 h', '2 à 3 h', '3 à 4 h', '4 à 5 h', 'Plus de 5 h'],
    },
    {
    ...
    },
    {
      ...
      'options': ['1 à 2 fois / mois', '1 fois / semaine', '2 fois / semaine', '3 fois / semaine', '4 fois / semaine'],
    },
    {
      'text': 'Combien de minutes consacrez-vous en moyenne à chaque séance d’activité physique ?',
      'options': ['Moins de 15 min', '16 à 30 min', '31 à 45 min', '46 à 60 min', 'Plus de 60 min'],
    },
    {
    ...
    },
    {
      ...
      'options': ['Moins de 2 h', '2 à 3 h', '5 à 6 h', '7 à 9 h', 'Plus de 10 h'],
    },
    {
          ...
          builder: (_) => AlertDialog(
            ...
            actions: [
              TextButton(
                ...
                onPressed: () => Navigator.pushReplacementNamed(context, '/testpage') // Va à la page "accueil"
              ),
            ],
          ),
        );
